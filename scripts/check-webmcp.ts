...
assert.match(registered.get('replace_character_asset')!.description, /Never route image bytes through model text/)
assert.match(registered.get('replace_character_asset')!.description, /visible file control/)
