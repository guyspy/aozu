...
if (new URLSearchParams(location.search).has('responsive')) {
  ...
  document.querySelector('.world-card .workspace-card-open').click()
  ...
  check(scopedActions.includes('Move to folder'), 'Storyboard actions include folder assignment')
  check(!document.querySelector('.story-document button[aria-label="Folder"]'), 'Storyboard paper omits the folder selector')
