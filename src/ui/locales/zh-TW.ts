...
export const zhTW: Messages = {
  ...
  navigation: { breadcrumb: '所在位置', primary: '主要導覽', library: '資料庫導覽', home: '首頁', notFound: '找不到這個頁面' },
  startup: {
    loading: '正在載入本機資料…',
    error: '無法載入本機資料，請重新整理後再試一次。',
  },
  draft: { name: '角色名稱', download: '匯出角色' },
  books: { ...en.books, default: '我的設定', shelf: '我的收藏', all: '所有設定集',
    ...
    createHint: '把角色與場景整理進這個設定集，再從「設定集資料」加入世界觀。', actions: '設定集與備份選單', move: '移至設定集', empty: '準備收進你的角色', emptyDefault: '建立第一個角色，或從上方選單匯入角色。', emptyCustom: '在「我的設定」找到角色，從角色選單把它移進來。', browseDefault: '瀏覽我的設定',
    delete: '刪除設定集', deleteHint: '要刪除「{{name}}」嗎？設定集裡的角色與場景會回到「我的設定」。', importHint: '匯入的角色會放進「我的設定」。', unsaved: '尚未儲存' },
  library: {
    backupTitle: '角色資料',
  ...
  characterDraft: {
    ...
    profile: {
      ...
      edit: '編輯角色資料',
      noDescription: '尚未填寫簡介。', noBackstory: '尚未填寫背景故事。',
    },
    alignment: {
      label: '對齊預覽',
      composite: '合成',
