export const en = {
  ...
  characterDraft: {
    start: {
      ...
      manualHelp: 'AOZU works best with a WebMCP-compatible browser. Open ChatGPT desktop and send the prefilled message to have your agent open this page.',
      desktopTitle: 'Continue in ChatGPT desktop',
      desktopPrompt: 'Open this AOZU page in the built-in browser and help me create a character using its site tools: {{url}}',
