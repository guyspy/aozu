export const en = {
  ...
  modelSheet: {
    appearances: {
      title: 'Appearance', choose: 'Saved Appearance', unnamed: 'Untitled Appearance',
      saveNew: 'Save as new Appearance', rename: 'Rename', name: 'Appearance name', save: 'Create Appearance',
      saveNewHelp: 'Save as a new Appearance before editing to keep the original.',
    },
    ...
    brief: 'Choose a saved Appearance. Its A-pose fills an empty front view automatically; add the other views with the same outfit and pose, keeping the whole character in frame.',
