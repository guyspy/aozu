export const en = {
  ...
  modelSheet: {
    ...
    brief: 'Use the same outfit and pose across views. Appearance starts in A-pose; capture front from the current appearance and keep the whole character in frame.',
