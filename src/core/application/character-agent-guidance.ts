...
export const CHARACTER_A_POSE_GUIDANCE = 'The first Appearance body establishes a front A-pose: upright torso, neutral face, arms angled down and away from the torso, relaxed visible hands, stable feet, and the complete head-to-feet silhouette inside the canvas. Use a neutral skin-tone character body base made only for wardrobe registration, presented as a non-sexual, non-pornographic design mannequin. Keep anatomy simplified and non-explicit: use flat, featureless skin-tone coverage over the chest and pelvis, with no nipples, genitals, intimate contours, sheer areas, or suggestive framing. Do not add seams or styling that read as underwear, lingerie, or swimwear. Keep the coverage area visually minimal while leaving the shoulders, arms, legs, waist, and body contours unobstructed for clean garment layering. Avoid loose fabric, footwear, jewelry, and accessories. This is the AOZU authoring convention, not a claim of skeleton compatibility. Preserve this pose and registration in derived outfits, hair, headwear, and expressions. Existing artwork is not automatically verified A-pose; review it visually before proposing a baseline change, which can make derived layers stale.'
