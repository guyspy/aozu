...
export const CHARACTER_A_POSE_GUIDANCE = 'The first Appearance body establishes a front A-pose: upright torso, neutral face, arms angled down and away from the torso, relaxed visible hands, stable feet, and the complete head-to-feet silhouette inside the canvas. Use a neutral nude-color body base made only for wardrobe registration. Present it as a non-sexual, non-pornographic character-design reference with ordinary non-explicit anatomy and minimal neutral coverage only where needed. Do not turn that coverage into visible underwear or swimwear styling. Keep the shoulders, arms, legs, waist, and body contours unobstructed for clean garment layering; omit footwear, jewelry, and accessories. This is the AOZU authoring convention, not a claim of skeleton compatibility. Preserve this pose and registration in derived outfits, hair, headwear, and expressions. Existing artwork is not automatically verified A-pose; review it visually before proposing a baseline change, which can make derived layers stale.'
